    ...
    >
      ...
      <span
        ...
        style={{
          ...
          boxShadow: '0 4px 24px rgba(37,211,102,0.35), 0 1px 4px rgba(0,0,0,0.3)',
        }}
      >
        {/* Official WhatsApp phone icon */}
        <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M16 3C8.82 3 3 8.82 3 16c0 2.34.63 4.6 1.82 6.57L3 29l6.6-1.79A13 13 0 0 0 16 29c7.18 0 13-5.82 13-13S23.18 3 16 3Z"
            fill="white"
            fillOpacity="0.15"
          />
          <path
