// Legacy PnL-report-based distribution flow. Retained until Phase 3C rebuilds
// the /admin/distributions page to use the new rate-driven flow in
// `distributions.ts`. After 3C this file can be deleted.
...
export async function getDistributionRunLegacy(
